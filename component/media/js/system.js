...
if (typeof akeeba.System === "undefined")
{
    ...
    /**
     * Akeeba options storage
     *
     * @type {{}}
     */
    akeeba.System.optionsStorage = null;
...
akeeba.System.getOptions = function (key, defaultValue)
{
    ...
    {
        akeeba.System.loadJoomlaOptions();
    ...
    // Backwards compatibility: Use Joomla.getOptions if running under Joomla
    if ((typeof Joomla !== "undefined") && (typeof Joomla.getOptions !== "undefined"))
    {
        return Joomla.getOptions(key, defaultValue);
    }
...
/**
 * Appropriate Joomla script options, marking them as loaded by our code
 */
akeeba.System.loadJoomlaOptions = function ()
{
    var elements = document.querySelectorAll(".joomla-script-options");

    akeeba.System.iterateNodes(elements, function (element)
    {
        if (akeeba.System.hasClass(element, "akeebaImported"))
        {
            return;
        }
        ...
        akeeba.System.addClass(element, "akeebaImported");
    });
};
...
akeeba.System.data = (function ()
{
    ...
    return {
         ...
         * @param {String} property - The name of the data attribute WITHOUT the "data-" prefix
         ...
         * @param {Element} element - The element to set the attribute for
         * @param {String} property - The name of the data attribute WITHOUT the "data-" prefix
         * @param {*} [defaultValue=null] - The default value ot return if the property is missing
         *
         * @returns {*}
         */
 ...
 *
 * Call as akeeba.System.documentReady(eventHandlerFunction)
 */
    ...
    "_": function (key, def)
         {
             ...
             ["akeeba.text", "joomla.jtext"].forEach(function (optionsKey)
             {
                 var newStrings = akeeba.System.getOptions(optionsKey);
             ...
             // When running under Joomla fall back to Joomla.JText / Joomla.Text
