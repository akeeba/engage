...
akeeba.Engage.Comments.onReplyButton=function(a){a.preventDefault();var b=akeeba.Engage.Comments.getElementFromEvent(a);if(null===b)return!1;a=1*akeeba.System.data.get(b,"akengageid",0);b=akeeba.System.data.get(b,"akengagereplyto",0);var c=document.forms.akengageCommentForm,d=document.getElementById("akengage-comment-inreplyto-wrapper");c.parent_id.value=a;d.style.display="none";0!==a&&(document.getElementById("akengage-comment-inreplyto-name").innerText=b,d.style.display="block");document.location.hash=
"";document.location.hash="#akengageCommentForm"};akeeba.Engage.Comments.onCancelReplyButton=function(a){a.preventDefault();a=document.forms.akengageCommentForm;var b=document.getElementById("akengage-comment-inreplyto-wrapper"),c=document.getElementById("akengage-comment-inreplyto-name");a.parent_id.value=0;b.style.display="none";c.innerText=""};
...
a instanceof Element&&a.setAttribute("checked","checked")))}};
