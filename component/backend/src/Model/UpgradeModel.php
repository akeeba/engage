...
class UpgradeModel extends BaseModel
{
	...
	private const REMOVE_FROM_ALL_VERSIONS = [
		'files'   => [
			 ...
			 */
			JPATH_ADMINISTRATOR . '/tmpl/Comments/default.blade.php',
			JPATH_ADMINISTRATOR . '/tmpl/Comments/form.blade.php',
			JPATH_ADMINISTRATOR . '/tmpl/Common/ShowUser.blade.php',
			JPATH_ADMINISTRATOR . '/tmpl/Common/README.php',
			JPATH_ADMINISTRATOR . '/tmpl/EmailTemplates/default.blade.php',
			JPATH_ADMINISTRATOR . '/tmpl/EmailTemplates/form.blade.php',
		],
		'folders' => [
